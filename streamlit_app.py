    ...
    try:
        ...
        if cropped_photo is not None:
            ...
            with col_stats:
                ...
                _check("tilt", "Pose & Roll Rotation")
                _check("yaw", "Pose & Yaw (Left/Right)")
                _check("pitch", "Pose & Pitch (Up/Down)")
                ...
                _check("shadows", "Lighting — Shadows & Asymmetry")
                _check("contrast", "Image Contrast")
                _check("expression", "Expression (Neutral)")
